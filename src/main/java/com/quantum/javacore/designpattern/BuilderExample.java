...
public class BuilderExample {
	...
	public static void main(String[] args) {
		...
		Computer computer1=new Computer.ComputerBuilder("100GB","4GB").setGraphicsCardEnabled(true)
				.setBluetoothEnabled(true).build();
		Computer computer2=new Computer.ComputerBuilder("100GB","4GB").setGraphicsCardEnabled(true)
